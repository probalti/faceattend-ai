...
const SOCIALS = [
  { icon: <Icons.Github   className="w-4 h-4" />, href: "#", label: "GitHub"   },
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row items-start
          ...
          <div className="max-w-xs">
            ...
            <p className="text-white/30 text-[13px] leading-[1.7]">
              ...
              Built as a Final Year Project using YOLOv8, FaceNet, and FastAPI.
            </p>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center
          ...
          <span className="text-white/20 text-[12px]">
            © 2025 FaceAttend AI · Zaffar Wasiya and Omama · Final Year Project
          </span>
