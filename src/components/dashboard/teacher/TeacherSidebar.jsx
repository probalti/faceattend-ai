...
import { TEACHER_NAV }            from "@/constants/navLinks";
import { ROUTES }                 from "@/constants/routes";

const ICON_MAP = {
  BarChart:  <Icons.BarChart  className="w-[18px] h-[18px]" />,
  Camera:    <Icons.Camera    className="w-[18px] h-[18px]" />,
...
const COLOR = "#a855f7"; // teacher accent
      ...
      {!collapsed && (
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-purple-400 text-[11px] font-mono font-bold">
              TEACHER PANEL
            </span>
          </div>
        </motion.div>
